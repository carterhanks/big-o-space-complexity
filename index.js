...
// ANSWER: I don't think so, since the function would always have to loop over an unlimited (.length) amount of data
...
// ANSWER: Both functions are still relying/dependent on the input of the string, which we cannot predict. So both are going to have the same space complexity.
